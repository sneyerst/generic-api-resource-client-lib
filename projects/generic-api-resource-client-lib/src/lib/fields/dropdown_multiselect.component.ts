...
@Component({
  selector: 'generic-api-resource-dropdown_multiselect',
  template: `
    <div [formGroup]="parentFormGroup">
      <mat-form-field>
        <mat-select placeholder="{{formComponent.label}}" formControlName="{{formComponent.name}}" multiple>
...
export class DropdownMultiselectComponent extends Field {
